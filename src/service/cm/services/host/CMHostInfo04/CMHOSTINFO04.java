package service.cm.services.host.CMHostInfo04;
 ...
 */
public class CMHOSTINFO04 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		FOX_MGR_CM_HOSTINFO_DBO result = FOX_MGR_CM_HOSTINFO_DAO.query(dbo);
		if (result == null) {
			// 失败
		} else {
			// 成功
