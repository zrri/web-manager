package service.auth.services.f04.f0404;
 ...
 */
public class F0404 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		FOX_MGR_AUTH_ROLEINFO_DBO result = FOX_MGR_AUTH_ROLEINFO_DAO.query(dbo);
		if (result == null) {
			// 失败
		} else {
			// 成功
