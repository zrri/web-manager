package service.auth.services.f01.f0104;
 ...
 */
public class F0104 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		FOX_MGR_AUTH_ORGINFO_DBO result = FOX_MGR_AUTH_ORGINFO_DAO.query(dbo);
		if (result == null) {
			// 失败
		} else {
			// 成功
