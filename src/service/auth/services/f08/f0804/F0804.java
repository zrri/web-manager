package service.auth.services.f08.f0804;
 ...
 */
public class F0804 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		FOX_MGR_AUTH_ROLEFUNCMAPPING_DBO result = FOX_MGR_AUTH_ROLEFUNCMAPPING_DAO.query(dbo);
		if (result == null) {
			// 失败
		} else {
			// 成功
