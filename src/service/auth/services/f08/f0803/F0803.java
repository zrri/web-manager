package service.auth.services.f08.f0803;
 ...
 */
public class F0803 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		int result = FOX_MGR_AUTH_ROLEFUNCMAPPING_DAO.delete(dbo);
		if (result == -1) {
			// 失败
		} else {
			// 成功
