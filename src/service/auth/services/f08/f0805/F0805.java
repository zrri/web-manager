package service.auth.services.f08.f0805;
 ...
 */
public class F0805 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		List<FOX_MGR_AUTH_ROLEFUNCMAPPING_DBO> result = FOX_MGR_AUTH_ROLEFUNCMAPPING_DAO.queryTable(dbo);
		if (result == null) {
			// 失败
		} else {
			// 成功
