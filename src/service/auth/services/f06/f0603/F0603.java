package service.auth.services.f06.f0603;
 ...
 */
public class F0603 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		int result = FOX_MGR_AUTH_FUNCMENUTREE_DAO.delete(dbo);
		if (result == -1) {
			// 失败
		} else {
			// 成功
	...
	public JsonResponse removeMenuInfo(JsonRequest request) throws Exception {
		// 从请求报文中解析参数
		// 功能编号
		String FUNCID = request.getAsString("FUNCID");
		// 菜单名称
