package service.auth.services.f03.f0303;
 ...
 */
public class F0303 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		int result = FOX_MGR_AUTH_TELLERROLEMAPPING_DAO.delete(dbo);
		if (result == -1) {
			// 失败
		} else {
			// 成功
