package service.auth.services.f03.f0304;
 ...
 */
public class F0304 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		FOX_MGR_AUTH_TELLERROLEMAPPING_DBO result = FOX_MGR_AUTH_TELLERROLEMAPPING_DAO.query(dbo);
		if (result == null) {
			// 失败
		} else {
			// 成功
