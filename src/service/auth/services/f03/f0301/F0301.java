package service.auth.services.f03.f0301;
 ...
 */
public class F0301 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		int result = FOX_MGR_AUTH_TELLERROLEMAPPING_DAO.insert(dbo);
		if (result == -1) {
			// 失败
		} else {
			// 成功
