package service.auth.services.f05.f0503;
 ...
 */
public class F0503 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		int result = FOX_MGR_AUTH_FUNCGROUPINFO_DAO.delete(dbo);
		if (result == -1) {
			// 失败
		} else {
			// 成功
