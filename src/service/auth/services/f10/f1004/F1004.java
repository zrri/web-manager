package service.auth.services.f10.f1004;
 ...
 */
public class F1004 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		FOX_MGR_AUTH_TELLEREXTENDINFO_DBO result = FOX_MGR_AUTH_TELLEREXTENDINFO_DAO.query(dbo);
		if (result == null) {
			// 失败
		} else {
			// 成功
