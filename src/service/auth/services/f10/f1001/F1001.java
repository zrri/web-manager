package service.auth.services.f10.f1001;
 ...
 */
public class F1001 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		int result = FOX_MGR_AUTH_TELLEREXTENDINFO_DAO.insert(dbo);
		if (result == -1) {
			// 失败
		} else {
			// 成功
