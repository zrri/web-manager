package service.auth.services.f10.f1003;
 ...
 */
public class F1003 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		int result = FOX_MGR_AUTH_TELLEREXTENDINFO_DAO.delete(dbo);
		if (result == -1) {
			// 失败
		} else {
			// 成功
