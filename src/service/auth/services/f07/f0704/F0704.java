package service.auth.services.f07.f0704;
 ...
 */
public class F0704 extends Service<JsonRequest, JsonResponse> {
	...
	public JsonResponse execute(JsonRequest request) throws Exception {
		...
		// 读取数据库
		FOX_MGR_AUTH_FUNC_DBO result = FOX_MGR_AUTH_FUNC_DAO.query(dbo);
		if (result == null) {
			// 失败
		} else {
			// 成功
