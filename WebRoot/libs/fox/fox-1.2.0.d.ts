...
declare namespace fox.core {
    ...
    interface MountedCallback {
         ...
         * @param exports
         */
        (code: number, exports: any, root: any): void;
    }
    /**
     * mount handler
     */
    ...
    class Router {
         ...
         * @returns {any}
         */
        replace(...args: any[]): Deferred;
        /**
         * 路由跳转(替换原来内容)
         *
         * @returns {any}
         */
        append(...args: any[]): Deferred;
        /**
         * 移除append方式加入的页面
         ...
         * @returns {boolean}
         */
        private releasePages(pages, all, isChild);
        /**
         * 卸载
         * @param rootId
         * @param index
         * @returns {boolean}
         */
        unMount(rootId: string, index: number): boolean;
        /**
         * 判断元素是否为父子关系
         * @param root
         * @param node
         */
        private isChildNode(root, child);
        /**
         * 发送消息
         * @param id
         * @param type
         ...
         * @returns number
         */
        private lastIndexOfPages(rootId);
        /**
         * 查找page
         * @param rootId
         * @returns number
 ...
 */
declare namespace fox {
    let type: typeof core.Utils.type;
    let isFunction: typeof core.Utils.isFunction;
    let isArray: typeof core.Utils.isArray;
    let makeArray: typeof core.Utils.makeArray;
    let merge: typeof core.Utils.merge;
    let isWindow: typeof core.Utils.isWindow;
    let isPlainObject: typeof core.Utils.isPlainObject;
    let extend: typeof core.Utils.extend;
    let clone: typeof core.Utils.clone;
    let isArrayLike: typeof core.Utils.isArrayLike;
    let each: typeof core.Utils.each;
    let getInnerText: typeof core.Utils.getInnerText;
    let setInnerText: typeof core.Utils.setInnerText;
    let getNextElementSibling: typeof core.Utils.getNextElementSibling;
    let getFirstElementChild: typeof core.Utils.getFirstElementChild;
